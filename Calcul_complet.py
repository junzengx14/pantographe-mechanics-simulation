...
nearPoint1=(( (2*bb)+k+(c/2)+(2*bb)+k)/2, (2*bb-(c/2)+2*bb)/2), nearPoint2=(((2*bb)+k+(c/2)+(2*bb)+k+c)/2, (2*bb-(c/2)+2*bb)/2   ), radius=r4)                   
                                    
#* curve d-f  c4
pr.FilletByRadius(curve1= s.findAt((  ( (2*bb)+k+(c/2)+(2*bb)+k)/2, (2*bb-(c/2)+2*bb)/2   )),
curve2=s.findAt(( ((2*bb)+k+ (2*bb)+k+(c/2))/2, (2*bb+(2*bb)+(c/2))/2  )), 
nearPoint1=(( (2*bb)+k+(c/2)+(2*bb)+k)/2, (2*bb-(c/2)+2*bb)/2), nearPoint2=(((2*bb)+k+ (2*bb)+k+(c/2))/2, (2*bb+(2*bb)+(c/2))/2 ), radius=r4)                   
...
nearPoint1=((k+(c/2)+(2*bb)+k+(c/2))/2, (0.0+2*bb-(c/2))/2), nearPoint2=((2*bb+k+(c/2)+(c/2)+k+(4*bb))/2, ((2*bb)-(c/2)+0.0)/2  ), radius=r5)                   
                  
# curve q-p  c12                                  
pr.FilletByRadius(curve1= s.findAt((  (0.0+2*bb)/2, ((c/2)+2*bb)/2   )),
curve2=s.findAt((  (0.0-(2*bb))/2, (c/2+2*bb)/2  )), 
nearPoint1=((0.0+2*bb)/2, ((c/2)+2*bb)/2), nearPoint2=((0.0-(2*bb))/2, (c/2+2*bb)/2  ), radius=r5)                  
                                   
# curve m-n c2
pr.FilletByRadius(curve1= s.findAt((  (k+(c/2)+(2*bb)+k+(c/2))/2, (0.0+-(2*bb)+(c/2))/2   )),
curve2=s.findAt((    (k+(c/2)+(2*bb)+k+(c/2))/2, (0.0+2*bb-(c/2))/2    )), 
nearPoint1=(    (k+(c/2)+(2*bb)+k+(c/2))/2, (0.0+-(2*bb)+(c/2))/2    )  , nearPoint2=(   (k+(c/2)+(2*bb)+k+(c/2))/2, (0.0+2*bb-(c/2))/2    ) , radius=r1)                                         

# curve p-r  c1                
pr.FilletByRadius(curve1= s.findAt((  (0.0+2*bb)/2, (c/2+2*bb)/2   )),
curve2=s.findAt((    (2*bb+0.0)/2, (2*bb+(4*bb)-(c/2))/2    )), 
nearPoint1=(    (0.0+2*bb)/2, (c/2+2*bb)/2     )  , nearPoint2=(  (2*bb+0.0)/2, (2*bb+(4*bb)-(c/2))/2    ) , radius=r1)   
